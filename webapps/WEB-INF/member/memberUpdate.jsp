						...
						<tbody>
							<tr>
								...
								<td>
									<div class="form-row">
										...
										<input type="hidden" name="hiddenid" id="hiddenid" value="${member.id }" />
									</div>
								</td>
							</tr>
							<tr>
								<th>비밀번호</th>
								<td>
									<input type="password" name="pw" id="pw" placeholder="변경할 비밀번호를 입력하세요." value="${member.pw }" required />
								</td>
							</tr>
							<tr>
								<th>비밀번호 확인</th>
								<td><input type="password" name="pw2" id="pw2" placeholder="변경할 비밀번호를 다시 한 번 입력하세요." />
									<input type="hidden" name="hiddenpw" id="hiddenpw" value="${member.pw }" />
								</td>
							</tr>
							<tr>
								<th>회원이름</th>
								<td><input type="text" name="name" id="name" placeholder="이름을 입력하세요." class="form-control" value="${member.name }" /></td>
							</tr>
							<tr>
								<th>연락처</th>
								<td>
									<input type="tel" name="tel" id="tel" value="${member.tel }" placeholder="연락처를 입력하세요." required>
									<p>공란없이 11자리를 입력하세요.</p>
								</td>
							</tr>
							<tr>
								<th>이메일</th>
								<td><input type="email" name="email" id="email" placeholder="이메일 주소를 입력하세요." value="${member.email }"></td>
							</tr>
							<tr>
								<th>주소</th>
								<td>
							...
							<tr>
								<td colspan="2">
									...
									<a href="${path }/MemberMyPage.do" class="btn btn-primary">마이페이지로 이동</a>
								</td>
							</tr>
						</tbody>
					</table>
